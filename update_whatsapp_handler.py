#!/usr/bin/env python3
"""Update WhatsApp handler to use omni imports"""

def update_whatsapp_handler():
    filepath = "/home/cezar/automagik/automagik-omni/src/channels/handlers/whatsapp_chat_handler.py"
    ...
    content = content.replace(
        'class WhatsAppChatHandler(WhatsAppChannelHandler, UnifiedChannelHandler):',
    ...
    print("Updated WhatsApp handler successfully!")

if __name__ == "__main__":
    update_whatsapp_handler()
...
class TestEvolutionApiSenderMentions:
    ...
    @pytest.mark.parametrize("text,mentions,mentions_everyone,expected_mention_count", [
    ...
    @patch('src.channels.whatsapp.evolution_api_sender.requests.post')
    def test_mention_combinations(self, mock_post, sender, mock_response, text, mentions, mentions_everyone, expected_mention_count):

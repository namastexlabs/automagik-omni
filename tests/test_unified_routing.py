...
Tests the UnifiedMessageRouter with unified fields and routing decisions.
"""
...
from src.services.message_router_unified import UnifiedMessageRouter
from src.db.models import InstanceConfig, User


class TestUnifiedMessageRouterInit:
...
class TestUnifiedMessageRouterRouteTypeDetermination:
...
class TestUnifiedMessageRouterStreamingLogic:
...
class TestUnifiedMessageRouterMainProcessing:
    ...
    @pytest.mark.asyncio
    @patch('src.services.message_router_unified.UnifiedMessageRouter._process_hive_streaming')
    ...
    @pytest.mark.asyncio
    @patch('src.services.message_router_unified.UnifiedMessageRouter._process_hive_standard')
    ...
    @pytest.mark.asyncio
    @patch('src.services.message_router_unified.UnifiedMessageRouter._process_automagik_standard')
...
class TestUnifiedMessageRouterHiveStreaming:
...
class TestUnifiedMessageRouterHiveStandard:
...
class TestUnifiedMessageRouterAutomagikStandard:
...
class TestUnifiedMessageRouterResponseNormalization:
...
class TestUnifiedMessageRouterStreamingHelpers:
...
class TestUnifiedMessageRouterErrorHandling:
...
class TestUnifiedMessageRouterIntegration:

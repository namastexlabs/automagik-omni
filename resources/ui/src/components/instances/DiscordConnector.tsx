...
import { api } from '@/lib';
import { AlertCircle, ArrowLeft, CheckCircle2, ChevronDown, ExternalLink, Loader2 } from 'lucide-react';
      ...
      <div className="text-center space-y-4">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            {isConnected ? `"${instanceName}" is now connected` : 'Enter your Discord bot token to connect'}
          </p>
        </div>
      </div>
      ...
      {isConnected && (
        <div className="flex flex-col items-center space-y-4 py-8 animate-fade-in">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground">Your Discord bot is now ready to use</p>
          </div>
        </div>
      )}
      ...
      {!isConnected && (
        <div className="space-y-4">
          ...
          <Collapsible open={helpOpen} onOpenChange={setHelpOpen}>
            <CollapsibleTrigger asChild>
              <Button variant="ghost" size="sm" className="w-full justify-between">
                <span className="text-sm text-muted-foreground">How do I get a bot token?</span>
          ...
          <div className="flex gap-3 pt-2">
            <Button variant="outline" onClick={onBack} className="flex-1" disabled={createMutation.isPending}>

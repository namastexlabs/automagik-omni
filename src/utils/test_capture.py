...
class TestCapture:
    ...
    def capture_media_message(self, webhook_data: Dict[str, Any], instance_config=None) -> Optional[str]:
        ...
        try:
            ...
            is_media = any(key in message_obj for key in ['imageMessage', 'videoMessage', 'audioMessage', 'documentMessage'])
        ...
        for media_type in media_types:
            if media_type in message_obj:
                ...
                media_item = {
                    ...
                    "alt_text": media_info.get('caption', f"Real {media_type.replace('Message', '')} from WhatsApp")
                }

...
def _resolve_recipient(user_id: Optional[str], phone_number: Optional[str], db: Session) -> str:
    """
...
async def test_schema_endpoint(
    ...
    return {"message": "Test endpoint", "user_id": request.user_id, "test_field": request.test_field}
...
class UserManagementService:
    ...
    def __init__(self):
        ...
        if not self.api_key:
            logger.warning("Agent API key not set. User management API requests will likely fail.")
    ...
    def create_user(self, phone_number: str, email: Optional[str] = None, user_data: Optional[Dict[str, Any]] = None) -> Optional[Dict[str, Any]]:
        """
        Create a new user.
    ...
    def get_or_create_user(self, phone_number: str, email: Optional[str] = None, user_data: Optional[Dict[str, Any]] = None) -> Optional[Dict[str, Any]]:
        """
